---
title: "Accelerating QMCPy Notebook Tests with Parsl"
author: "Joshua Jay Herman, Brandon Sharp, and Sou-Cheng Choi"
date: 2025-11-29
date-format: "MMMM D, YYYY"
description: "How Parsl parallelism accelerates QMCPy notebook testing while preserving the existing Testbook workflow."
categories:
  - "QMCPy"
  - "Testing"
  - "Parallel Computing"
image: figures/parsl-worker-scaling.png
---
...
The presentation slides are available as [Parsl Testbook Speedup](https://qmcsoftware.github.io/QMCSoftware/demos/talk_paper_demos/Parslfest_2025/Parsl_Testbook_Speedup.pdf).
...
<figure id="fig-parsl-four-worker-speedup">
  <img src="figures/parsl-four-worker-speedup.png" alt="Sequential and four-worker Parsl execution times and speedup">
...
<figure id="fig-parsl-worker-scaling">
  <img src="figures/parsl-worker-scaling.png" alt="Execution time and speedup versus number of Parsl workers">
...
2. ParslFest 2025 presentation materials:
   [Parsl Testbook Speedup](https://qmcsoftware.github.io/QMCSoftware/demos/talk_paper_demos/Parslfest_2025/Parsl_Testbook_Speedup.pdf).
