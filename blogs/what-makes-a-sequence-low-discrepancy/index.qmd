---
title: "What Makes a Sequence Low Discrepancy?"
author: "Fred J. Hickernell"
date: 2020-07-08
date-format: "MMMM D, YYYY"
description: "Discrepancy as a measure of uniformity and why low-discrepancy sequences improve QMC integration."
categories:
  - "Quasi-Monte Carlo"
...
The first blog post, [Why Add Q to MC?](../why-add-q-to-mc/index.qmd), introduced the concept of evenly spread points, which are commonly referred to as *low discrepancy* (LD) points. This is in contrast to independent and identically distributed (IID) points.
